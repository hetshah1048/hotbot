...
log.info("--------------------------------------")
log.info("|> Hotstar Checker Bot By @Luciferrr_xD <|")
log.info("--------------------------------------")
...
async def start(_, message: Message):      
    await message.reply("Hello, I am a simple hotstar checker bot created by @@Luciferrr_xD! Type /help to get to know about my usages!")
